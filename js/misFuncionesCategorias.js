...
function pintarRespuesta(respuesta){
    ...
    let myTable="<table>";
    myTable+="<tr>";
    myTable+="<caption><h3>Detalle de Categorias</h3></caption>"
...
function guardarInformacionCategorias(){
    ...
    let var2 = {
        ...
        url:"http://155.248.202.105:8080/api/Category/save",
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://155.248.202.105:8080/api/Category/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    $.ajax({
        url:"http://155.248.202.105:8080/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
